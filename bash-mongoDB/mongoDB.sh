...
#echo "deb [ arch=amd64,arm64 ] https://repo.mongodb.org/apt/ubuntu noble/mongodb-org/8.0 multiverse" | tee /etc/apt/sources.list.d/mongodb.list
...
if [[ -z "$(mongo --version 2> /dev/null | grep '8.0')" ]]
    then
